...
describe('creates a background image attribute', () => {
    ...
    it('extracts a url with spacing', () => {
        ...
        assert.equal(imageWithSpacing.value, imageUrl);
    });
    ...
    it('extracts a url without spacing', () => {
        ...
        assert.equal(imageWithoutSpacing.value, imageUrl);
    });
    ...
    it('extracts a url without quotes', () => {
        ...
        assert.equal(imageWithoutQuotes.value, imageUrl);
    });
    ...
    it('extracts a url with single quotes', () => {
        ...
        assert.equal(imageWithSingleQuotes.value, imageUrl);
    });
    ...
    it('extracts a url with double quotes', () => {
        ...
        assert.equal(imageWithDoubleQuotes.value, imageUrl);
    });

    it('returns null if the url is empty', () => {
        assert.equal(new BackgroundImage('', 'whatever').value, null);
    });

    it('returns null if the url is invalid', () => {
        assert.equal(new BackgroundImage('whatever', 'whatever').value, null);
    })
});
